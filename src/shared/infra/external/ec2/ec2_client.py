...
class EC2Client:
    ...
    async def detect_objects(self, image_url: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        Envia uma solicitação para detectar objetos em uma imagem.
    ...
    async def analyze_maturation(self, image_url: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        Envia uma solicitação para analisar a maturação em uma imagem.
        ...
        Returns:
            Dict: Resultado da análise de maturação
        """
        payload = {
            "image_url": image_url,
            "metadata": metadata or {}
