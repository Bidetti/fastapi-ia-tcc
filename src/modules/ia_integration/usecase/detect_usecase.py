...
class DetectUseCase:
    ...
    async def execute(self, image_url: str, user_id: str, metadata: Optional[Dict[str, Any]] = None) -> ProcessingResult:
        """
        ...
        try:
            ...
            result = await self.ia_repository.detect_objects(image)
