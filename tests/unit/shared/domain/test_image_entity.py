...
class TestImageEntity:
    def test_image_creation(self):
        ...
        metadata = {"original_filename": "banana_batch_42.jpg", "content_type": "image/jpeg"}
    ...
    def test_image_to_dict(self):
        ...
        metadata = {"original_filename": "banana_shelf_life.jpg", "content_type": "image/jpeg"}
    ...
    def test_image_from_dict(self):
        image_dict = {
            ...
            "metadata": {"original_filename": "banana_shipment_91.jpg", "content_type": "image/jpeg"},
