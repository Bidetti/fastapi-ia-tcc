...
class TestProcessingResultEntity:
    ...
    def test_processing_result_from_dict(self):
        ...
        assert processing_result.summary == {"maturation_points_identified": 12, "analysis_time_ms": 360}
        assert processing_result.image_result_url == "https://fruit-analysis.com/results/banana_ripeness_assessment_654.jpg"